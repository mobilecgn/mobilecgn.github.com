...
<p>
	...
	<!--
	<br/><br/>
	Falls euch Themen einfallen, die Ihr gerne selber Vortragen möchtet:
	schreibt uns eine Mail an spam&nbsp;(at)&nbsp;mobilecologne.de
	-->
</p>
...
<p>
	...
	<table style="margin-top: 0;">
		<tr>
			<td class="span-2">19:00 Uhr</td>
			<td>Opening (Warmlaufen / Kennenlernen / Networking)</td>
		</tr>
		<tr>
			<td class="span-2">19:25 Uhr</td>
			<td>Verlosung</td>
		</tr>
		<tr>
			<td class="span-2">19:30 Uhr</td>
			<td>Vorträge / Lightning Talks</td>
		</tr>
		<tr>
			<td class="span-2">danach</td>
			<td>
...
{% include _location_gasmotorenfabrik.html %}
-->
...
<h3 class="thistogglenext">Maxim Zaks über Neo4OC - Neo4j Graphdatenbank mit Objective-C</h3>
<section>
	<ul>
...
<h3 class="thistogglenext">Jörg Vanderhoeven über Debugging von mobilen Webseiten (und Webviews)</h3>
<section>
	<p>
...
<h3 class="thistogglenext">Dominique Winter über Mobile Natural User Interface - vom Wischen, Tappen und Sprechen</h3>
<section>
	Ein großartiger Talk vom langen Weg von CLI über GUIs zu NUIs.

	<div style="width: 510px" id="__ss_13524785">
		<strong style="display: block; margin: 12px 0 4px;"><a href="https://www.slideshare.net/designik/mobile-nui" title="Mobile NUI" target="_blank">Mobile NUI</a></strong>
		...
		<div style="padding:5px 0 12px">View more presentations from <a href="https://www.slideshare.net/designik" target="_blank">designik</a></div>
	</div>
</section>
