...
<div class="container span-13">
	<p>
		...
		<strong>am Donnerstag, den 9. Februar ab 18:30 Uhr</strong> in den
        Coworking-Space <strong><a href="https://ehren.space/" target="_blank">Ehrenspace</a></strong>
        einladen.
	</p>
	<p>
		Dieser Vortragsabend widmet sich ganz den beiden
        Spracherkennungs- und steuerungssystemen
        <strong>Alexa&nbsp;von&nbsp;Amazon</strong> sowie
        <strong>Siri&nbsp;von&nbsp;Apple</strong>.
    </p>
	<p>
        Michael und Thomas stellen die beiden Entwicklungssysteme
        <strong>ASK (Alexa Skills Kit)</strong> und <strong>SiriKit</strong> vor.
        Anschließend freuen wir uns auf einen angeregten Austausch mit euch.
	</p><br/>

    <p>
		<strong>Alexa Skill Entwicklung mit ASK (Alexa Skills Kit)</strong>
	</p>
	<p>
    ...
    <p>
		<strong>iOS Sprachteuerung mit Siri &amp; SiriKit</strong>
	</p>
	<p>
...
<div class="container span-15 last clear">
	...
	<div class="span-13 last">
		<p>
			<strong>Alexa Skill Entwicklung mit ASK</strong><br/>
            Michael Kleinhenz von <a href="https://www.redhat.com/de/technologies/mobile" target="_blank">RedHat</a>
        </p>
        <p>
            <strong>iOS Sprachteuerung mit Siri &amp; SiriKit</strong><br/>
